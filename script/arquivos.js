...
arquivosForm.addEventListener('submit', (event) => {
    ...
    // 2. Criptografia removida: a criptografia acontecerá na Camada de Apresentação (JWT)
    const nomeCriptografado = somenteNome;
    const formatoCriptografado = somenteFormato;
    const remetenteCriptografado = remetenteDigitado;
    ...
    const arquivo = {
        nomeArquivo: nomeCriptografado,      
        formato: formatoCriptografado,          
